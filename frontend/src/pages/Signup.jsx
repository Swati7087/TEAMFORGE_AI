...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-[#050508] flex items-center justify-center px-4 py-10 relative overflow-hidden">
      <div className="absolute top-[-15%] right-[-5%] w-[500px] h-[500px] bg-green-500/15 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-[-15%] left-[-5%] w-[500px] h-[500px] bg-pink-500/15 rounded-full blur-[140px] pointer-events-none" />
      <FloatingShapes />
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-[#0a0a12]/40 backdrop-blur-md border border-white/[0.12] rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-400 mt-1">Start building with your team</p>
          </div>
